...
import work.kozh.entity.Element;
import work.kozh.widget.FindViewByIdDialog;
...
//                fromText.append("/****" + text + "****/\n");
            ...
            fromText.append("@InjectView(" + element.getFullID() + ")\n");
    ...
    private void generateOnClickMethod() {
        for (Element element : mElements) {
            ...
            if (element.isCreateClickMethod()) {
                // 需要创建OnClick方法
                String methodName = "on" + Util.firstToUpperCase(getClickMethodName(element)) + "Click";
    ...
    private void createClickMethod(String methodName, Element element) {
        ...
        methodBuilder.append("@ViewClick(" + element.getFullID() + ")\n");
